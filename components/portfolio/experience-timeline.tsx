...
const entries: Entry[] = [
  {
    ...
    time: "Jan 2026 · Remote",
    tag: "ongoing",
    bullets: [
      "Contributing to projects focused on entrepreneurship and innovation.",
      "Improving documentation, triaging issues, and onboarding new contributors.",
      "Assisting with UI improvements and small feature enhancements.",
    ],
  },
  {
    kind: "exp",
    ...
    tag: "ongoing",
    bullets: [
      "Working with global contributors on community driven software.",
      "Code reviews, documentation, and feature development with real maintainers.",
    ],
  },
  {
    kind: "exp",
